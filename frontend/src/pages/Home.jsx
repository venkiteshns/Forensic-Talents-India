...
import { ArrowRight, Shield, Search, FileText, Fingerprint, Monitor, CheckCircle, GraduationCap, Scale, BrainCircuit, Users, Award, Activity, Bell, Leaf, Landmark, Star, MessageSquare, Send, Upload, Camera } from 'lucide-react';
                ...
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-slate-500 mb-1">Click the circle to upload your photo</p>
