      ...
      <section className="py-20 bg-white">
        <Container>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 md:gap-6">
            <Link to="/education" className="bg-slate-50 hover:bg-white p-8 border border-transparent border-l-4 border-l-accent hover:border-slate-100 rounded-lg flex flex-col items-center justify-center text-center aspect-square transition-all duration-300 group hover:shadow-xl relative overflow-hidden">
              <Presentation size={48} className="text-accent mb-4 group-hover:-translate-y-2 transition-transform duration-300" strokeWidth={1.5} />
              <h3 className="text-lg font-bold text-slate-700">Training</h3>
            </Link>
            <Link to="/education" className="bg-slate-50 hover:bg-white p-8 border border-transparent border-l-4 border-l-accent hover:border-slate-100 rounded-lg flex flex-col items-center justify-center text-center aspect-square transition-all duration-300 group hover:shadow-xl relative overflow-hidden">
              <GraduationCap size={48} className="text-accent mb-4 group-hover:-translate-y-2 transition-transform duration-300" strokeWidth={1.5} />
              <h3 className="text-lg font-bold text-slate-700">Internship</h3>
            </Link>
            <Link to="/education" className="bg-slate-50 hover:bg-white p-8 border border-transparent border-l-4 border-l-accent hover:border-slate-100 rounded-lg flex flex-col items-center justify-center text-center aspect-square transition-all duration-300 group hover:shadow-xl relative overflow-hidden">
              <Users size={48} className="text-accent mb-4 group-hover:-translate-y-2 transition-transform duration-300" strokeWidth={1.5} />
              <h3 className="text-lg font-bold text-slate-700">Personal Classes</h3>
            </Link>
            <Link to="/education" className="bg-slate-50 hover:bg-white p-8 border border-transparent border-l-4 border-l-accent hover:border-slate-100 rounded-lg flex flex-col items-center justify-center text-center aspect-square transition-all duration-300 group hover:shadow-xl relative overflow-hidden">
              <Award size={48} className="text-accent mb-4 group-hover:-translate-y-2 transition-transform duration-300" strokeWidth={1.5} />
              <h3 className="text-lg font-bold text-slate-700">Certificate Courses</h3>
            </Link>
          </div>
