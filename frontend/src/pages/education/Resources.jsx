...
function ResourceCard({ resource, index }) {
  ...
  return (
    <motion.div
      ...
      className="group bg-white rounded-xl shadow-md border border-slate-200 overflow-hidden hover:shadow-xl hover:-translate-y-1 transition-all duration-300 flex flex-col h-full block"
    >
      ...
      <div className="p-6 flex-1 flex flex-col">
        <h3 className="font-semibold text-slate-800 text-lg mb-2 leading-snug line-clamp-2 group-hover:text-primary transition-colors">{resource.title}</h3>
        ...
        <a
          ...
          className="mt-auto flex items-center justify-center gap-2 w-full px-4 py-2.5 rounded-md text-sm font-medium text-white bg-slate-800 group-hover:bg-primary transition-colors shadow-sm"
        >
          <CtaIcon size={18} />
  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20 font-sans">
      ...
      <motion.section 
        ...
        className="relative pt-24 pb-20 text-center flex items-center justify-center border-b-[8px] border-accent mb-16 overflow-hidden" style={{ minHeight: '400px' }}
      >
        ...
        <Container className="relative z-10">
          <motion.div variants={containerVariants} className="max-w-4xl mx-auto">
            <motion.h1 variants={textVariants} className="text-4xl md:text-5xl font-heading font-bold text-white mb-6 drop-shadow-md">
              Forensic Resources &amp; Downloads
            </motion.h1>
            <motion.p variants={textVariants} className="text-slate-200 text-lg max-w-3xl mx-auto leading-relaxed drop-shadow-sm">
      ...
      <Container>
        {loading ? (
          ...
          <>
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={containerVariants} className="mb-8 flex items-center justify-between flex-wrap gap-4">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.15 }} variants={containerVariants} className="mx-auto max-w-4xl">
            <motion.div variants={cardVariants} className="relative overflow-hidden rounded-3xl border border-slate-100 bg-white p-8 text-center shadow-xl md:p-16">
              {/* Background Accent */}
              ...
              <motion.h2 variants={textVariants} className="mb-6 font-heading text-3xl font-bold text-slate-800">
                Resources Coming Soon
              </motion.h2>

              <motion.p variants={textVariants} className="mx-auto mb-10 max-w-2xl text-lg leading-relaxed text-slate-600">
              ...
              {/* Expectations block */}
              <motion.div variants={cardVariants} className="mx-auto mb-12 max-w-2xl rounded-2xl border border-slate-100 bg-slate-50 p-8 text-left shadow-sm">
              ...
              {/* CTAs */}
              <motion.div variants={textVariants} className="flex flex-col items-center justify-center gap-4 sm:flex-row">
